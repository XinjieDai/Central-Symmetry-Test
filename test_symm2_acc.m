function power_symm = test_symm2_acc(M,N,setting,n,p)
...
c = 1;
for b = 0.5:0.5:1.5
T(c) = (1/n^2) * sum( Y_add_norm.^(b/2) - Y_subtr_norm.^(b/2) );
c = c + 1;
end
end
...
c = 1;
for b = 0.5:0.5:1.5
T(c,:) = (1/n^2) * sum( Y_boot_add_norm.^(b/2) - Y_boot_subtr_norm.^(b/2) );
c = c + 1;
end
end
